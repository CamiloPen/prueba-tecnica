...
import { IonCard, IonCardContent, IonInput, IonList, IonButton, IonContent, IonHeader, IonTitle, IonToolbar } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonCard, IonCardContent, RouterLink, IonInput, IonList, IonButton, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
